...
const STACK = {
  ...
  Frontend: ["Next.js (App Router)", "React 19", "Redux Toolkit", "Tailwind CSS", "Shadcn/Radix"],
  Backend: ["Node.js", "Express", "REST APIs", "Socket.io", "Pusher", "WebSockets"],
  Data: ["MongoDB / Mongoose", "Prisma", "SQL"],
  Payments: ["Ziraat 3D Secure", "Pagar.me", "PayFast", "HMAC Webhooks"],
  "AI & Cloud": ["Google Generative AI", "GCP Cloud Run", "Vercel", "Firebase FCM", "Cloudinary"],
};
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8 min-w-0">
          <a href="#top" className="font-bold tracking-tighter text-base sm:text-lg truncate">
        ...
        <div className="flex items-center gap-3 sm:gap-6 text-[11px] font-mono uppercase tracking-widest">
          ...
          <a href="#stack" className="hidden sm:inline hover:text-accent transition-colors">
            Stack
          </a>
          <a href="#about" className="hidden sm:inline hover:text-accent transition-colors">
            About
          </a>
          <a
            href="#contact"
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-8 animate-reveal">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-[0.9] text-balance mb-8">
            Architecting <br />
            <span className="text-muted-foreground">high-concurrency</span> <br />
            MERN systems.
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-pretty max-w-[36ch] font-medium leading-relaxed text-foreground/85">
            Full-stack engineer specializing in Next.js, AI integrations and real-time
            payment infrastructure — shipped to production across five industries.
          </p>
        ...
        <aside className="col-span-12 md:col-span-4 flex flex-col justify-end animate-reveal [animation-delay:200ms]">
          <div className="border-l-2 border-accent pl-6 py-2">
            ...
            <p className="text-sm text-foreground/80 mb-5 leading-relaxed">
              2+ years architecting end-to-end platforms — from clinical telemedicine
              to AI veterinary diagnostics — with a focus on performance, security and
              scale.
            </p>
            <div className="flex flex-wrap gap-2">
              {["Next.js 16", "TypeScript", "Node.js", "MongoDB", "Google GenAI"].map((t) => (
                <span
                  key={t}
  ...
  return (
    <div id={id} className="flex items-end justify-between mb-12 scroll-mt-24">
      <div>
        ...
        <h2 className="text-2xl sm:text-3xl font-bold tracking-tighter uppercase">{title}</h2>
      </div>
...
function Work() {
  return (
    <section className="mb-32">
      <SectionHeader id="work" label="[ 002 — Production Ledger ]" title="Selected Production Work" />
      <div>
        {PROJECTS.map((p, i) => (
          <article
            key={p.id}
          ...
          >
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <a
                href={p.url.startsWith("http") || p.url.includes(".") ? `https://${p.url.replace(/^https?:\/\//, "")}` : "#"}
...
function Stack() {
  return (
    <section className="mb-32">
      <SectionHeader id="stack" label="[ 003 — Engineering Stack ]" title="Core Technologies" />
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-4">
...
function Experience() {
  return (
    <section className="mb-32">
      <SectionHeader id="experience" label="[ 004 — Career Log ]" title="Experience" />
      <div className="grid grid-cols-12 gap-6">
        {EXPERIENCE.map((e, i) => (
          <div
            key={e.period}
          ...
          >
            ...
            <p className="text-accent text-sm font-mono mt-1 mb-4">@ {e.company}</p>
...
function About() {
  return (
    <section className="mb-32">
      <SectionHeader id="about" label="[ 005 — Operator Notes ]" title="About" />
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-7 space-y-5 text-base sm:text-lg leading-relaxed text-foreground/85">
          <p>
            I'm Ahmad — a full-stack developer based in Lahore, Pakistan. I spend my
            time architecting end-to-end web platforms where correctness matters:
            payment flows that have to settle, clinical workflows that can't drop
            data, real-time systems that have to stay consistent.
          </p>
          <p>
            Over the last two years I've shipped production work across
            telemedicine, travel, veterinary diagnostics, EdTech and mobile
            backends — usually owning the full stack from Mongo schema to Next.js
            App Router UI to the Cloud Run / VPS deployment.
          </p>
          <p>
            Currently studying Computer Science at Virtual University of Pakistan
            (6th semester) while continuing to build at ML Bench.
          </p>
        </div>
        <div className="col-span-12 md:col-span-5 md:pl-12">
          <div className="border-l-2 border-accent pl-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-sm">
                Telemedicine · Travel · Veterinary AI · EdTech · Mobile · SaaS / CRM
              </p>
            </div>
            <div>
              <p className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground mb-2">
              ...
              <p className="text-sm">
                Open to senior full-stack engagements — remote, contract or full-time.
              </p>
            </div>
          </div>
        </div>
...
function Contact() {
  return (
    <section id="contact" className="mb-24 scroll-mt-24">
      <SectionHeader id="contact-h" label="[ 006 — Contact Endpoint ]" title="Let's Build" />
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-7">
          <h3 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-[0.95] text-balance mb-8">
            Have a system that needs <span className="text-accent">architecting?</span>
          </h3>
          <a
            href="mailto:ahmadrazakhalid9.0@gmail.com"
          ...
          >
            ...
            <span aria-hidden className="text-accent group-hover:translate-x-1 transition-transform inline-block">
              →
            </span>
          </a>
